...
export class NewsDialogComponent implements OnInit{
  ...
  packNewsList(){
    this.allNews = [
      new News('v.1.0.9', this.makeDate(28, 4, 2025),
        ["Изменилась иконка добавления связи экземпляра из под модели", "Изменилась подпись при наведении на иконку экземпляра из под модели"]),
