  ...
  packNewsList(){
    this.allNews = [
      ...
      new News('v.1.0.1', this.makeDate(1,6, 2024),
        ['Добавились настройки.', 'Работает пагинация.', 'Основные кнопки добавления/изменения/изменения активности/удаления.', 'Работают все методы взаимодействия для основных сущностей.']),
